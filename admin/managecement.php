...
<head>
    ...
    <title>Manage Cement</title>
</head>
<body class="bg-yellow-200">
    <h1 class="text-center mt-10 text-2xl font-bold">Cement Table</h1>
    ...
    <tr>
        ...
        <td class="border-2 text-center border-gray-800 border-collapse py-2 w-36"><a class="px-6 py-1 text-white rounded-md bg-blue-500 font-bold" href="updatecement.php?id=<?php echo $rows['id'] ?>">Update</a></td>
        <td class="border-2 text-center border-gray-800 border-collapse py-2 w-36"><a class="px-6 py-1 text-white rounded-md bg-red-500 font-bold" href="deletecement.php?id=<?php echo $rows['id'] ?>">Delete</a></td>
