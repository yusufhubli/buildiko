...
<h1 class="text-center mt-10 text-2xl font-bold">Steel Table</h1>
    ...
    <tr>
        ...
        <td class="border-2 text-center border-gray-800 border-collapse py-2 w-36"><a class="px-6 py-1 text-white rounded-md bg-blue-500 font-bold" href="updatesteel.php?id=<?php echo $rows['id'] ?>">Update</a></td>
        <td class="border-2 text-center border-gray-800 border-collapse py-2 w-36"><a class="px-6 py-1 text-white rounded-md bg-red-500 font-bold" href="deletesteel.php?id=<?php echo $rows['id'] ?>">Delete</a></td>
