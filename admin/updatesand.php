...
if (isset($_POST['submit']))
{
    ...
    $updatequery = "update sand set id='$id',name='$name',type='$type',qty='$qty',price='$price',category='$category' where id = '$idupdate'" ;
...
<body>
    ...
    <h2 class=" text-2xl font-bold text-center py-2">Update Sand</h2>
        <div id="signup">
