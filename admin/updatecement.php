...
if (isset($_POST['submit']))
{
    ...
    $updatequery = "update cement set id='$id',name='$name',type='$type',qty='$qty',price='$price',category='$category' where id = '$idupdate'" ;
...
<body class="bg-yellow-200 flex justify-center">
    ...
    <h2 class=" text-2xl font-bold text-center py-2">Update Cement</h2>
        <div id="signup">
            <form class="text-center" method="post" enctype="multipart/form-data">
                ...
                <input name="submit" class="w-80 px-2 py-1 hover:bg-yellow-300 text-lg rounded-md bg-yellow-400 font-bold my-3" type="submit" value="Update">
            </form>
        </div>
    </div>
